...
Includes comprehensive integration tests against reference outputs from original R scripts.

## Performance

- **Memory efficient** streaming parsers for large files
- **Format detection** from file headers without full parsing
- **Zero-copy** where possible for optimal performance
- **Battle-tested** logic replicated from validated R scripts